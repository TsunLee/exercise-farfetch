...
const Kid = () => {
  ...
  const getProduct = async () => {
    const response = await fetch("http://localhost:5000/childrenProduct");
  ...
  return (
    <div className="kid">
      ...
      <div className="page-news">
        <h6>DESIGNER CLOTHING FOR </h6>
        <p>
          Shop the best global brands and curate your wardrobe with our
          selection of designer clothing for children.
        </p>
      </div>
